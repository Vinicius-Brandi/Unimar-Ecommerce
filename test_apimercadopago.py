...
class TestMercadoPago(unittest.TestCase):
    ...
    def test_realizar_pagamento_sucesso(self, MockSDK):
        ...
        mock_response_sucesso = {
            "response": {
                "init_point": "https://www.mercadopago.com.br/pagar"
            }
        }
        ...
        items = [{"id": "123", "title": "Produto Teste", "quantity": 1, "unit_price": 100}]
        external_reference = "REF-12345"
        application_fee = 10.0

        # Execução da função
        init_point = realizar_pagamento(seller_token, items, external_reference, application_fee)

        # Verificações (Asserts)
        self.assertEqual(init_point, "https://www.mercadopago.com.br/pagar")
        MockSDK.assert_called_once_with(seller_token) # Verifica se o SDK foi iniciado com o token correto
    ...
    def test_realizar_pagamento_falha_api(self, MockSDK):
        ...
        mock_response_falha = {
            "response": {
                "message": "Invalid seller access token"
            }
        }
    ...
    def test_realizar_pagamento_falha_desconhecida(self, MockSDK):
        ...
        self.assertEqual(
            str(context.exception),
            "Erro ao criar link de pagamento: Erro desconhecido"
        )